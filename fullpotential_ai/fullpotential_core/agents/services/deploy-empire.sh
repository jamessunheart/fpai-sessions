...
echo ""
echo "Control:"
echo "  🛑 Stop All:        $FPAI_ROOT/agents/services/stop-empire.sh"
echo "  📊 Monitor:         $FPAI_ROOT/agents/services/monitor-empire.sh"
echo "  🔄 Restart:         $FPAI_ROOT/agents/services/deploy-empire.sh"
echo ""
