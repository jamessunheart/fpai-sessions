...
```python
# Triggers:
- "James just opened VSCode in /agents/services/i-match" → Offers help
...
║                                                            ║
║  👤 James Status:                                          ║
║     Location: Working in /agents/services/i-match                 ║
...
```bash
cd /Users/jamessunheart/Development/agents/services/companion-claude
./install.sh
```
...
echo 'source /Users/jamessunheart/Development/agents/services/companion-claude/shell-integration.sh' >> ~/.zshrc
```
