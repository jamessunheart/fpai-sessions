...
Type=simple
User=root
WorkingDirectory=/opt/fpai/agents/services/proxy-manager
Environment="PATH=/opt/fpai/agents/services/proxy-manager/.venv/bin"
ExecStart=/opt/fpai/agents/services/proxy-manager/.venv/bin/uvicorn app.main:app --host 0.0.0.0 --port 8100
Restart=always
RestartSec=10
