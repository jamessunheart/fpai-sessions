...
/agents/services/ops/deploy-service.sh <service-name>
```
...
SERVICE=$1
rsync -av /agents/services/$SERVICE/ root@198.54.123.234:/opt/fpai/$SERVICE/
...
~/Development/agents/services/ops/auto-deploy.sh
```
