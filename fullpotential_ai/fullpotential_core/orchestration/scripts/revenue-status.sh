...
echo -e "     ${YELLOW}1.${NC} Configure SMTP in /agents/services/i-match/.env (30 min)"
...
echo -e "  cd agents/services/i-match && vi .env   # Configure SMTP"
echo -e "  cd agents/services/treasury-arena       # Review treasury strategies"
echo ""
