...
2. **Master Dashboard**
   ...
   - **Port:** 8026
   - **Path:** /agents/services/master-dashboard
   - **Status:** ✅ Active
...
3. **Treasury Dashboard**
   ...
   - **Port:** 8005
   - **Path:** /agents/services/treasury-dashboard
   - **Status:** ✅ Active
...
5. **Jobs Dashboard**
   ...
   - **Port:** 8008
   - **Path:** /agents/services/dashboard
   - **Status:** ✅ Active
...
6. **FPAI Hub**
   ...
   - **Port:** 8010
   - **Path:** /agents/services/treasury-manager (has dashboard)
   - **Status:** ✅ Active
...
7. **2X Treasury Dashboard**
   ...
   - **Port:** 8052
   - **Path:** /agents/services/2x-treasury
   - **Status:** ✅ Active
...
8. **Treasury Arena Dashboard**
   ...
   - **Port:** 8035
   - **Path:** /agents/services/treasury-arena
   - **Status:** ✅ Active

### Dashboard Directories (Built but may not be running):

9. **Approval Dashboard**
   - **Path:** /agents/services/approval-dashboard
   - **Purpose:** Governance approvals
   - **Status:** 📂 Directory exists

10. **Email Dashboard**
    - **Path:** /agents/services/email-dashboard
