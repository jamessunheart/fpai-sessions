...
```python
# agents/services/unified-chat/main.py
...
#!/bin/bash
# agents/services/unified-chat/connect-session.sh
...
```html
<!-- agents/services/unified-chat/chat.html -->
<!DOCTYPE html>
<html>
<head>
...
```bash
# 1. Create service
mkdir -p agents/services/unified-chat
...
./agents/services/unified-chat/connect-session.sh session-1
./agents/services/unified-chat/connect-session.sh session-2
