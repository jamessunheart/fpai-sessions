...
cat agents/services/[your-droplet-name]/SPECS.md
...
```bash
cd agents/services/[your-droplet-name]/BUILD
...
**Quick Status:**
```bash
cat agents/services/[droplet-name]/README.md
```
...
**Detailed Specs:**
```bash
cat agents/services/[droplet-name]/SPECS.md
```
...
```bash
# See current status
cat agents/services/church-guidance-ministry/README.md

# See full specs
cat agents/services/church-guidance-ministry/SPECS.md

# Start implementing (4-6 hours)
cd agents/services/church-guidance-ministry/BUILD/src
...
3. **`agents/services/church-guidance-ministry/SPECS.md`**
   - Fully documented specs (first example)
   - Comprehensive compliance notes
   - Ready for BUILD phase

4. **`agents/services/church-guidance-ministry/README.md`**
   - Progress tracking
   - Phase checklists
...
**Example:** `agents/services/church-guidance-ministry/`
