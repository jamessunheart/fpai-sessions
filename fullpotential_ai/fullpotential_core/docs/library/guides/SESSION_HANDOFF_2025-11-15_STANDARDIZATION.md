...
```bash
# Copy template
cp ARCHITECTURE/templates/SPEC_TEMPLATE.md agents/services/registry/SPEC_Registry.md
...
**Generate SPEC:**
```bash
cp ARCHITECTURE/templates/SPEC_TEMPLATE.md agents/services/[service]/SPEC_[ServiceName].md
# Fill in 12 sections
```

**Generate README:**
```bash
cp ARCHITECTURE/templates/README_TEMPLATE.md agents/services/[service]/README.md
