...
cat agents/services/my-service/README.md

# See what's needed
cat agents/services/my-service/SPECS.md

# Check if production-ready
ls agents/services/my-service/PRODUCTION/
```
...
# 3. Create structure
mkdir -p agents/services/my-service/{BUILD/src,BUILD/tests,PRODUCTION}
...
cat agents/services/existing-service/README.md

# 2. Check SPECS for requirements
cat agents/services/existing-service/SPECS.md
