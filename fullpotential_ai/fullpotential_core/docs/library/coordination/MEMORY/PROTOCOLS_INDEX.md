...
**Check compliance:**
```bash
python3 agents/services/integrated-registry-system.py
```
...
- **Registry** - `agents/services/SERVICE_REGISTRY.json`
- **Template** - `agents/services/_TEMPLATE/`
- **Your Service** - `agents/services/your-service-name/`
