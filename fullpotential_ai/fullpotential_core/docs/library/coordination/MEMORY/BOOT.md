...
**Files:**
- `agents/services/task-automation/QUICK_START.md` - Quick reference
- `agents/services/task-automation/README.md` - Complete documentation
- `agents/services/task-automation/TASK_AUTOMATION_FRAMEWORK.md` - Architecture
...
2. Create automation task:
    ssh root@198.54.123.234 "cd /root/agents/services/task-automation && \
...
│
├── agents/services/                   # SERVICE DEVELOPMENT
...
cd ~/Development/agents/services/[service-name]
# ... edit code ...
...
**Major update:** ⭐ Protocol #7 - Task Automation Framework (CRITICAL)
  ...
  - See: `agents/services/task-automation/QUICK_START.md`
