...
│                                                             │
│  1. SCAN Phase                                              │
│     └─ Scan all agents/services/ directories                      │
...
async def trigger_build(service_name: str, assigned_session: str):
    ...
    work_ticket = {
        ...
        "spec_file": f"/Users/jamessunheart/Development/agents/services/{service_name}/SPEC.md",
        "deadline": "24 hours",
        "created_at": now()
    }
    ...
    await send_message(
        ...
        SPEC: /Users/jamessunheart/Development/agents/services/{service_name}/SPEC.md
        DEADLINE: 24 hours
...
class AutoVerifier:
    ...
    async def verify_spec(self, service: str) -> bool:
        ...
        spec_path = f"agents/services/{service}/SPEC.md"
    ...
    async def verify_build(self, service: str) -> bool:
        ...
        build_path = f"agents/services/{service}/BUILD"
