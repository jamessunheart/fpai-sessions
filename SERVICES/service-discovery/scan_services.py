...
Scans all services in SERVICES/ and creates a comprehensive registry
"""
import os
import re
import json
...
OUTPUT_FILE = Path("/Users/jamessunheart/Development/SERVICES/SERVICE_CATALOG.json")
...
def main():
    print("🔍 Scanning all services in SERVICES/...")
    print()
