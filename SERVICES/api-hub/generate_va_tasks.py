...
def main():
    ...
    for capability, purpose in capabilities.items():
        ...
        # Save task to file
        task_file = f"/Users/jamessunheart/Development/SERVICES/api-hub/tasks/{task_id}.json"
    ...
    # Save all tasks
    import os
    os.makedirs("/Users/jamessunheart/Development/SERVICES/api-hub/tasks", exist_ok=True)
    ...
    with open("/Users/jamessunheart/Development/SERVICES/api-hub/tasks/SUMMARY.json", 'w') as f:
    ...
    print(f"\n  Tasks created in: /Users/jamessunheart/Development/SERVICES/api-hub/tasks/")
