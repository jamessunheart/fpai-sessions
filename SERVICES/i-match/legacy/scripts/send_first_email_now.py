...
import sys
import json
sys.path.insert(0, '/Users/jamessunheart/Development/SERVICES/ai-automation')
...
# Load prospects
with open('/Users/jamessunheart/Development/SERVICES/i-match-automation/i_match_prospects_ready.json') as f:
    data = json.load(f)
