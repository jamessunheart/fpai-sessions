...
BASE_DIR="/Users/jamessunheart/Development/SERVICES/i-match"
...
# Check each system
LOG_DIR="/Users/jamessunheart/Development/SERVICES/i-match/autonomous_logs"
...
if [ -f "/Users/jamessunheart/Development/SERVICES/i-match/content_library.json" ]; then
    posts=$(python3 -c "import json; print(len(json.load(open('/Users/jamessunheart/Development/SERVICES/i-match/content_library.json'))['reddit_posts']))" 2>/dev/null || echo "?")
