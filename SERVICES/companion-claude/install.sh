...
export PATH="/Users/jamessunheart/Development/SERVICES/companion-claude:$PATH"
...
echo "   echo 'source /Users/jamessunheart/Development/SERVICES/companion-claude/shell-integration.sh' >> ~/.zshrc"
echo ""
