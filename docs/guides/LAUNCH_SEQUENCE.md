...
curl -X POST http://localhost:8007/deploy \
  ...
  -d '{
    "service_path": "/Users/jamessunheart/Development/SERVICES/credentials-manager",
...
curl -X POST http://localhost:8007/deploy \
  -H "Content-Type: application/json" \
  -d '{
    "service_path": "/Users/jamessunheart/Development/SERVICES/helper-management",
...
curl -X POST http://localhost:8300/fix \
  -H "Content-Type: application/json" \
  -d '{
    "droplet_path": "/Users/jamessunheart/Development/SERVICES/i-proactive",
...
curl -X POST http://localhost:8300/fix \
  -H "Content-Type: application/json" \
  -d '{
    "droplet_path": "/Users/jamessunheart/Development/SERVICES/i-match",
...
curl -X POST http://localhost:8007/deploy \
  -H "Content-Type: application/json" \
  -d '{
    "service_path": "/Users/jamessunheart/Development/SERVICES/i-match",
...
cd /Users/jamessunheart/Development/SERVICES/deployer
