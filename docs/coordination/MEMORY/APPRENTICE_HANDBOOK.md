...
mkdir -p SERVICES/my-service/BUILD/{src,tests}
mkdir -p SERVICES/my-service/PRODUCTION
```
...
```bash
# Update README
echo "Session #5 - Working on email templates (In Progress)" >> SERVICES/email-service/README.md
```
