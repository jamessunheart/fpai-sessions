...
3. **Session Files**: Check /root/SERVICES/master-dashboard/ for configs
...
Restart service:
```bash
ssh root@198.54.123.234 "pkill -f 'uvicorn.*8026' && cd /root/SERVICES/master-dashboard && nohup uvicorn main:app --host 0.0.0.0 --port 8026 > /tmp/master-dashboard.log 2>&1 &"
```
