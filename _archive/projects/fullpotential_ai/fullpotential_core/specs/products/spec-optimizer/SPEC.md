...
```json
{
  "file_path": "/Users/jamessunheart/Development/agents/services/jobs/SPEC.md",
...
```json
{
  "backup_path": "/Users/jamessunheart/Development/agents/services/jobs/SPEC.md.backup",
  "output_path": "/Users/jamessunheart/Development/agents/services/jobs/SPEC.optimized.md"
}
```
...
curl -X POST http://localhost:8206/batch-optimize \
  ...
  -d '{
    "file_paths": [
      "/Users/jamessunheart/Development/agents/services/autonomous-executor/SPEC.md",
      "/Users/jamessunheart/Development/agents/services/jobs/SPEC.md"
    ],
