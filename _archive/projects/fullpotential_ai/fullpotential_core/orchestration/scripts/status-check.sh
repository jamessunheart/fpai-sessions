...
# Outreach
echo "📣 OUTREACH:"
if [ -f /Users/jamessunheart/Development/agents/services/i-match/outreach_agent.pid ]; then
    PID=$(cat /Users/jamessunheart/Development/agents/services/i-match/outreach_agent.pid)
