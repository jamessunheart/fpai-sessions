...
- ✅ Local development (`~/Development/agents/services/`)
...
**Output:**
- Local: `~/Development/agents/services/payment-processor/`
...
# 2. Develop locally
cd ~/Development/agents/services/my-service
./start.sh
...
cd ~/Development/agents/services/i-proactive
# ... edit code ...
...
```json
{
  ...
  "port": 8400,
  "path_local": "/Users/jamessunheart/Development/agents/services/service-name",
...
- Run: `cat ~/Development/agents/services/SERVICE_REGISTRY.json | grep -A5 "name"`
