...
new_service = {
    ...
    "path_local": f"/Users/jamessunheart/Development/agents/services/$NAME",
    "path_production": f"/root/agents/services/$NAME",
    "tech_stack": [],
    "dependencies": [],
...
if [ $? -eq 0 ]; then
    ...
    echo "  2. Update registry: python3 ../../agents/services/integrated-registry-system.py"
