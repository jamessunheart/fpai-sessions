...
declare -a BLUEPRINT_DOCS=(
    "agents/services/registry/SPEC.md"
    "agents/services/orchestrator/SPEC.md"
    "agents/services/dashboard/SPEC.md"
    "agents/services/i-proactive/SPEC.md"
    "agents/services/i-match/SPEC.md"
)
