...
- Stored in `/root/agents/services/credentials-manager/.env`
...
# Update .env file
cd /root/agents/services/credentials-manager
...
**2. Server:**
- `/root/agents/services/credentials-manager/.env` (encryption keys)
- `/root/agents/services/credentials-manager/credentials.db` (encrypted credentials database)
...
# Backup from server
scp root@198.54.123.234:/root/agents/services/credentials-manager/.env ~/Backups/fpai-credentials/server-env
scp root@198.54.123.234:/root/agents/services/credentials-manager/credentials.db ~/Backups/fpai-credentials/server-db
