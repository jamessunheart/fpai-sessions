...
**Email Scripts:**
- `/agents/services/i-match/send_all_emails_now.py` - Batch send (executed)
- `/agents/services/i-match/send_first_email_now.py` - Test send (executed)

**Autonomous Manager:**
- `/agents/services/i-match/autonomous_outreach_manager.py` - Main system (running)
- `/agents/services/i-match/autonomous_outreach.db` - Tracking database
- `/agents/services/i-match/autonomous_outreach.log` - Live log

**Monitoring:**
- `/agents/services/i-match/AUTONOMOUS_OUTREACH_STATUS.md` - Full status doc

**Integration:**
- `/agents/services/ai-automation/marketing_engine/services/email_service_brevo.py` - Brevo API
