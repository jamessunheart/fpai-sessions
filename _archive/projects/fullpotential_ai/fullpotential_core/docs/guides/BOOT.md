...
├── agents/services/              # All UDC droplets live here
...
- Infrastructure: `/Users/jamessunheart/Development/agents/services/registry/SPEC.md`
- Sacred Loop: `/Users/jamessunheart/Development/agents/services/autonomous-executor/SPEC.md`
- Domain: `/Users/jamessunheart/Development/agents/services/jobs/SPEC.md`
...
curl -X POST http://localhost:8205/verify-file \
  -H "Content-Type: application/json" \
  -d '{"file_path": "/Users/jamessunheart/Development/agents/services/your-service/SPEC.md"}'
```
...
curl -X POST http://localhost:8206/optimize-file \
  -H "Content-Type: application/json" \
  -d '{
    "file_path": "/Users/jamessunheart/Development/agents/services/your-service/SPEC.md",
...
curl -X POST http://localhost:8402/executor/build-droplet \
  -H "Content-Type: application/json" \
  -d '{
    "spec_path": "/Users/jamessunheart/Development/agents/services/your-service/SPEC.md",
...
- Docs: `/Users/jamessunheart/Development/agents/services/spec-builder/SPEC.md`

**2. spec-optimizer (8206)** - Enhance existing SPECs
- Status: Requires `ANTHROPIC_API_KEY`
- Docs: `/Users/jamessunheart/Development/agents/services/spec-optimizer/SPEC.md`

**3. spec-verifier (8205)** - Validate SPECs
- Status: Active ✅
- Docs: `/Users/jamessunheart/Development/agents/services/spec-verifier/SPEC.md`
...
**Understand the mesh:**
1. Read `/Users/jamessunheart/Development/agents/services/TIER_0_1_UDC_RETROFIT_SPECS.md`
2. Check Registry for active services: `curl http://localhost:8000/droplets`
3. Review reference SPECs in `/Users/jamessunheart/Development/agents/services/*/SPEC.md`
...
### SPEC References
- **Registry SPEC** - `/Users/jamessunheart/Development/agents/services/registry/SPEC.md`
- **Orchestrator SPEC** - `/Users/jamessunheart/Development/agents/services/orchestrator/SPEC.md`
- **autonomous-executor SPEC** - `/Users/jamessunheart/Development/agents/services/autonomous-executor/SPEC.md`
- **jobs SPEC** - `/Users/jamessunheart/Development/agents/services/jobs/SPEC.md`

### SPEC Tools Documentation
- **spec-builder** - `/Users/jamessunheart/Development/agents/services/spec-builder/SPEC.md`
- **spec-optimizer** - `/Users/jamessunheart/Development/agents/services/spec-optimizer/SPEC.md`
- **spec-verifier** - `/Users/jamessunheart/Development/agents/services/spec-verifier/SPEC.md`
...
echo "ANTHROPIC_API_KEY=your-key" > /Users/jamessunheart/Development/agents/services/spec-optimizer/.env
echo "ANTHROPIC_API_KEY=your-key" > /Users/jamessunheart/Development/agents/services/spec-builder/.env

# Restart services
pkill -f "spec-optimizer/main.py"
pkill -f "spec-builder/main.py"

cd /Users/jamessunheart/Development/agents/services/spec-optimizer && nohup venv/bin/python3 main.py &
cd /Users/jamessunheart/Development/agents/services/spec-builder && nohup venv/bin/python3 main.py &
```
