...
**1. Copy to server:**
```bash
scp -r /Users/jamessunheart/Development/agents/services/contribution-bridge root@198.54.123.234:/root/agents/services/
```

**2. SSH to server:**
```bash
ssh root@198.54.123.234
cd /root/agents/services/contribution-bridge
```
...
Type=simple
User=root
WorkingDirectory=/root/agents/services/contribution-bridge
...
**Start service:**
```bash
cd /Users/jamessunheart/Development/agents/services/contribution-bridge
python3 app.py
```
