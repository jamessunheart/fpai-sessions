...
```bash
cd /Users/jamessunheart/Development/agents/services/coranation
python main.py
```
...
```bash
scp -r /Users/jamessunheart/Development/agents/services/coranation root@198.54.123.234:/opt/fpai/
```
