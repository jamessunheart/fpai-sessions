...
if [ -f ./scripts/session-set-credential.sh ]; then
    ...
    cat > /Users/jamessunheart/Development/agents/services/.namecheap-credentials << EOF
export NAMECHEAP_API_USER="$NC_USER"
export NAMECHEAP_API_KEY="$NC_KEY"
export NAMECHEAP_USERNAME="$NC_USER"
EOF
    chmod 600 /Users/jamessunheart/Development/agents/services/.namecheap-credentials
...
if [ $? -eq 0 ]; then
    ...
    echo "   cd /Users/jamessunheart/Development/agents/services/unified-chat"
