...
```json
{
  ...
  "specs": [
    {
      "name": "registry",
      "path": "/Users/jamessunheart/Development/agents/services/registry/SPEC.md",
      "tier": 0,
      "score": 98
    },
    {
      "name": "orchestrator",
      "path": "/Users/jamessunheart/Development/agents/services/orchestrator/SPEC.md",
      "tier": 0,
      "score": 96
    }
  ]
...
curl -X POST http://localhost:8205/verify \
  ...
  -d '{
    "spec_path": "/Users/jamessunheart/Development/agents/services/jobs/SPEC.md"
  }'
```
...
curl -X POST http://localhost:8205/compare \
  -H "Content-Type: application/json" \
  -d '{
    "spec_path": "/Users/jamessunheart/Development/agents/services/new-service/SPEC.md",
