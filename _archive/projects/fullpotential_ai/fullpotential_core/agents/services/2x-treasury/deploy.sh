...
rsync -avz --exclude '__pycache__' --exclude '*.pyc' \
    /Users/jamessunheart/Development/agents/services/2x-treasury/ \
    root@198.54.123.234:/root/agents/services/2x-treasury/

# Create systemd service on server
ssh root@198.54.123.234 << 'REMOTE'
cd /root/agents/services/2x-treasury
...
Type=simple
User=root
WorkingDirectory=/root/agents/services/2x-treasury
