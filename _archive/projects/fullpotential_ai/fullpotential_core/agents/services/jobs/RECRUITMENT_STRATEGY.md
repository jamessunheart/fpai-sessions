...
- Stored in `/root/agents/services/jobs/data/applications.json`
...
**File to create:** `/Users/jamessunheart/Development/agents/services/jobs/app/services/hiring_coordinator.py`
