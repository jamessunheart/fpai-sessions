...
```bash
# Sync to server
scp -r app/services/pot_service.py root@198.54.123.234:/opt/fpai/agents/services/i-match/app/services/
scp -r app/routes/contribute.py root@198.54.123.234:/opt/fpai/agents/services/i-match/app/routes/

# Update main.py
scp app/main.py root@198.54.123.234:/opt/fpai/agents/services/i-match/app/
...
cat /opt/fpai/agents/services/i-match/data/pot_transactions.json
```
