...
ssh root@198.54.123.234 "mkdir -p /root/SERVICES/magnet-trading"

# Upload system files
rsync -avz magnet-trading-system/ root@198.54.123.234:/root/SERVICES/magnet-trading/
...
```bash
cd /root/SERVICES/magnet-trading
...
```bash
# Add to crontab
0 0 * * * /root/SERVICES/magnet-trading/deployment/backup.sh
```
